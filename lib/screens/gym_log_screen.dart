...
import '../widgets/bravo_video_dialog.dart';
...
class GymLogScreen extends StatelessWidget {
                ...
                child: SafeArea(
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildExerciseGrid(context, state.selectedExercises),
                      ),
  ...
  Widget _buildExerciseGrid(
      BuildContext context, Set<ExerciseType> selected) {
      ...
      child: Wrap(
        ...
        children: ExerciseType.values.map((exercise) {
          return ExerciseButton(
            ...
            onTap: () => context.read<GymLogCubit>().toggleExercise(exercise),
          );
        }).toList(),
      ),
    );
